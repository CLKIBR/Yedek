...
namespace Persistence.Migrations
{
    ...
    [Migration("20250814145958_FeatureFlag")]
            ...
            modelBuilder.Entity("Domain.Entities.FeatureFlag", b =>
                {
                    ...
                    b.Property<string>("AllowedClaims")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("466344bb-df21-40b6-9277-c8ecaa319e2b"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "clkibrahim@outlook.com",
                            PasswordHash = new byte[] { 4, 174, 194, 102, 167, 172, 25, 92, 20, 222, 82, 181, 1, 161, 32, 5, 62, 21, 196, 241, 111, 241, 153, 165, 106, 183, 96, 96, 92, 90, 167, 158, 214, 109, 167, 158, 240, 42, 110, 89, 194, 25, 120, 215, 202, 254, 189, 195, 174, 156, 218, 65, 18, 79, 131, 218, 2, 253, 229, 20, 8, 137, 71, 173 },
                            PasswordSalt = new byte[] { 100, 115, 104, 225, 239, 17, 192, 129, 241, 109, 29, 201, 206, 124, 171, 5, 206, 215, 29, 156, 24, 51, 254, 169, 79, 213, 44, 205, 250, 24, 40, 228, 8, 151, 8, 47, 167, 75, 19, 100, 230, 167, 174, 107, 253, 10, 214, 255, 238, 5, 96, 209, 48, 142, 53, 184, 98, 135, 10, 230, 250, 99, 209, 170, 47, 130, 93, 216, 68, 222, 138, 146, 143, 4, 11, 154, 181, 137, 71, 225, 6, 216, 173, 204, 165, 0, 22, 115, 127, 249, 91, 71, 211, 98, 148, 2, 222, 122, 127, 40, 219, 138, 28, 206, 152, 237, 89, 210, 16, 134, 51, 90, 122, 10, 219, 130, 215, 174, 100, 168, 226, 143, 86, 9, 112, 188, 120, 69 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("373b892d-8ce9-4226-8234-82947eb47e22"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("466344bb-df21-40b6-9277-c8ecaa319e2b")
                        });
                });

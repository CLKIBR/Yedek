...
function checkAndSetAngularVersion() {
    ...
    const angularVersion = (VERSION === null || VERSION === void 0 ? void 0 : VERSION.major) && parseInt(VERSION.major, 10);
    if (angularVersion) {
...
const isNgZoneEnabled = typeof Zone !== 'undefined' && ((_a = Zone.root) === null || _a === void 0 ? void 0 : _a.run);
/**
    ...
    return target => {
        ...
        target.prototype.ngOnInit = function (...args) {
            tracingSpan = runOutsideAngular(() => startInactiveSpan({
                onlyIfParent: true,
                name: `<${(options === null || options === void 0 ? void 0 : options.name) || 'unnamed'}>`,
                op: ANGULAR_INIT_OP,
                attributes: {
    ...
    return (_target, propertyKey, descriptor) => {
        ...
        descriptor.value = function (...args) {
            ...
            runOutsideAngular(() => {
                startInactiveSpan({
                    onlyIfParent: true,
                    name: `<${(options === null || options === void 0 ? void 0 : options.name) ? options.name : 'unnamed'}>`,
...
function getParameterizedRouteFromSnapshot(route) {
    const parts = [];
    let currentRoute = route === null || route === void 0 ? void 0 : route.firstChild;
    while (currentRoute) {
        const path = (currentRoute === null || currentRoute === void 0 ? void 0 : currentRoute.routeConfig) && currentRoute.routeConfig.path;

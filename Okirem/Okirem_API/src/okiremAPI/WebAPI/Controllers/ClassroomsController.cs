...
public class ClassroomsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedClassroomResponse>> Delete([FromRoute] Guid id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdClassroomResponse>> GetById([FromRoute] Guid id)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<GetListResponse<GetListClassroomListItemDto>>> GetList([FromQuery] PageRequest pageRequest)
    {

...
public class ResetPasswordCommand : IRequest , ISecuredRequest
{
    ...
    public class ResetPasswordCommandHandler : IRequestHandler<ResetPasswordCommand>
    {
        ...
        public ResetPasswordCommandHandler(IUserService userService, IMapper mapper, AuthBusinessRules authBusinessRules, IUserRepository userRepository, IEmailAuthenticatorRepository emailAuthenticatorRepository)
        {

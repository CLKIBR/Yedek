...
public class SchoolsController : BaseController
{
    ...
    [HttpDelete("{id}")]
    public async Task<ActionResult<DeletedSchoolResponse>> Delete([FromRoute] Guid id)
    {
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<GetByIdSchoolResponse>> GetById([FromRoute] Guid id)
    {
    ...
    [HttpGet]
    public async Task<ActionResult<GetListResponse<GetListSchoolListItemDto>>> GetList([FromQuery] PageRequest pageRequest)
    {

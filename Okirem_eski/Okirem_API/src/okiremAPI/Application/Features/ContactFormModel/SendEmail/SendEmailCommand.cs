...
public class SendEmailCommandHandler : IRequestHandler<SendEmailCommand, Unit>
{
    ...
    public async Task<Unit> Handle(SendEmailCommand request, CancellationToken cancellationToken)
    {
        ...
        message.From.Add(new MailboxAddress("Okirem", "okiremschool@gmail.com"));
        message.To.Add(new MailboxAddress("Recipient", "okiremschool@gmail.com")); // veya alıcı email adresi
        ...
        var mail = new Mail
        {
            ...
            ToList = new List<MailboxAddress> { new MailboxAddress("Recipient", "okiremschool@gmail.com") } // Alıcının email adresini burada güncelleyin
        };
